import ProfileImage from "../assets/icons/noauth-avatar.svg";
import Tag from "./Tag";

const FeedCard = () => {
  return (
    <div className="shadow-light p-7 px-10 max-w-screen-sm border border-border rounded-lg hover:cursor-pointer hover:shadow-light-hover hover:scale-101 transition duration-300 ease-in-out">
