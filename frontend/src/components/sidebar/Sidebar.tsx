...
const Sidebar = () => {
  ...
  return (
    <div className="fixed left-0 lg:pl-7 pl-5 w-64 h-sidebar lg:border-r bg-white dark:bg-background border-gray-200 pt-5 overflow-auto flex flex-col justify-between ">
