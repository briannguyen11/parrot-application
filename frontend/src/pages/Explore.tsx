    ...
    <div className="w-full pt-5">
      <div className="grid grid-cols-1 ">
        <h1 className="mt-4 text-3xl font-bold font-raleway text-primary">
          Discover projects from <br className="inline-block md:hidden"/><span className=" bg-parrot-gradient inline-block text-transparent bg-clip-text">creative</span> minds
        </h1>
        <p className="text-secondary font-normal mt-2 font-montserrat text-sm max-w-[600px]">
