    ...
    <div className="w-full pt-5">
      <div className="grid grid-cols-1 ">
        <h1 className="mt-4 text-3xl font-bold font-raleway text-primary">
          Discover projects from <br className="inline-block sm:hidden"/><span className=" bg-parrot-gradient inline-block text-transparent bg-clip-text">creative</span> minds
        </h1>
